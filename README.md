...
<p align="center">
  ...
  <a href="https://weblate.cutwire.org/projects/drift/">Translate</a> ·
...
- `i18n/drift_<lang>.ts` — one file per language, created by Weblate when a translator starts a locale
...
Translations are collected at [weblate.cutwire.org](https://weblate.cutwire.org/projects/drift/). Create an account there and pick a language; new locales get an `i18n/drift_<lang>.ts` file on a pull request.

The Weblate component is set up as:

- **File format:** Qt Linguist translation file
- **File mask:** `i18n/drift_*.ts`
- **Template / new base:** `i18n/drift.ts`
- **New translation:** `i18n/drift_%(language)s.ts`
- **Source language:** English
- **Push:** a `weblate` branch and pull requests, so translations are reviewed

The [wlc](https://docs.weblate.org/en/latest/wlc.html) CLI reads [`.weblate`](.weblate) in this repo.
